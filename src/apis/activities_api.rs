...
pub trait ActivitiesApi {
    fn create_activity(&self, name: &str, _type: &str, start_date_local: String, elapsed_time: i32, description: &str, distance: f32, trainer: i32, commute: i32) -> Box<Future<Item = ::models::DetailedActivity, Error = Error<serde_json::Value>>>;
    ...
    fn get_comments_by_activity_id(&self, id: i64, page: i32, per_page: i32) -> Box<Future<Item = Vec<::models::Comment>, Error = Error<serde_json::Value>>>;
    ...
    fn get_zones_by_activity_id(&self, id: i32) -> Box<Future<Item = Vec<::models::ActivityZone>, Error = Error<serde_json::Value>>>;
