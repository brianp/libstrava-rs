...
pub trait RoutesApi {
    fn get_route_as_gpx(&self, id: i32) -> Box<Future<Item = (), Error = Error<serde_json::Value>>>;
    fn get_route_as_tcx(&self, id: i32) -> Box<Future<Item = (), Error = Error<serde_json::Value>>>;
    fn get_route_by_id(&self, id: i32) -> Box<Future<Item = ::models::Route, Error = Error<serde_json::Value>>>;
    fn get_routes_by_athlete_id(&self, id: i32, page: i32, per_page: i32) -> Box<Future<Item = Vec<::models::Route>, Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>RoutesApi for RoutesApiClient<C> {
    ...
    fn get_routes_by_athlete_id(&self, id: i32, page: i32, per_page: i32) -> Box<Future<Item = Vec<::models::Route>, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/athletes/{id}/routes?{}", configuration.base_path, query_string, id=id);
