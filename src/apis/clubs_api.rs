...
pub trait ClubsApi {
    fn get_club_activities_by_id(&self, id: i32, page: i32, per_page: i32) -> Box<Future<Item = Vec<::models::SummaryActivity>, Error = Error<serde_json::Value>>>;
    fn get_club_admins_by_id(&self, id: i32, page: i32, per_page: i32) -> Box<Future<Item = Vec<::models::SummaryAthlete>, Error = Error<serde_json::Value>>>;
    fn get_club_by_id(&self, id: i32) -> Box<Future<Item = ::models::DetailedClub, Error = Error<serde_json::Value>>>;
    fn get_club_members_by_id(&self, id: i32, page: i32, per_page: i32) -> Box<Future<Item = Vec<::models::SummaryAthlete>, Error = Error<serde_json::Value>>>;
