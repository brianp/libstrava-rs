...
impl DistanceStream {
  ...
  pub fn with_original_size(mut self, original_size: i32) -> DistanceStream {
    self.original_size = Some(original_size);
    self
  }
  ...
  pub fn with_resolution(mut self, resolution: String) -> DistanceStream {
    self.resolution = Some(resolution);
    self
  }
  ...
  pub fn with_series_type(mut self, series_type: String) -> DistanceStream {
    self.series_type = Some(series_type);
    self
  }
  ...
  pub fn with_data(mut self, data: Vec<f32>) -> DistanceStream {
    self.data = Some(data);
    self
  }
