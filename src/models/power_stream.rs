...
impl PowerStream {
  ...
  pub fn with_original_size(mut self, original_size: i32) -> PowerStream {
    self.original_size = Some(original_size);
    self
  }
  ...
  pub fn with_resolution(mut self, resolution: String) -> PowerStream {
    self.resolution = Some(resolution);
    self
  }
  ...
  pub fn with_series_type(mut self, series_type: String) -> PowerStream {
    self.series_type = Some(series_type);
    self
  }
  ...
  pub fn with_data(mut self, data: Vec<i32>) -> PowerStream {
    self.data = Some(data);
    self
  }
