...
pub struct LatLngStream {
  ...
  #[serde(rename = "data")]
  data: Option<Vec<::models::LatLng>>
}

impl LatLngStream {
  pub fn new() -> LatLngStream {
    LatLngStream {
      original_size: None,
      resolution: None,
      series_type: None,
  ...
  pub fn with_original_size(mut self, original_size: i32) -> LatLngStream {
    self.original_size = Some(original_size);
    self
  }
  ...
  pub fn with_resolution(mut self, resolution: String) -> LatLngStream {
    self.resolution = Some(resolution);
    self
  }
  ...
  pub fn with_series_type(mut self, series_type: String) -> LatLngStream {
    self.series_type = Some(series_type);
    self
  }
  ...
  pub fn set_data(&mut self, data: Vec<::models::LatLng>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::LatLng>) -> LatLngStream {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::LatLng>> {
    self.data.as_ref()
  }
