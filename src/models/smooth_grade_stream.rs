...
impl SmoothGradeStream {
  pub fn new() -> SmoothGradeStream {
    SmoothGradeStream {
      original_size: None,
      resolution: None,
      series_type: None,
  ...
  pub fn with_original_size(mut self, original_size: i32) -> SmoothGradeStream {
    self.original_size = Some(original_size);
    self
  }
  ...
  pub fn with_resolution(mut self, resolution: String) -> SmoothGradeStream {
    self.resolution = Some(resolution);
    self
  }
  ...
  pub fn with_series_type(mut self, series_type: String) -> SmoothGradeStream {
    self.series_type = Some(series_type);
    self
  }
  ...
  pub fn with_data(mut self, data: Vec<f32>) -> SmoothGradeStream {
    self.data = Some(data);
    self
  }
