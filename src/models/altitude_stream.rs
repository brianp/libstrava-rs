...
impl AltitudeStream {
  ...
  pub fn with_original_size(mut self, original_size: i32) -> AltitudeStream {
    self.original_size = Some(original_size);
    self
  }
  ...
  pub fn with_resolution(mut self, resolution: String) -> AltitudeStream {
    self.resolution = Some(resolution);
    self
  }
  ...
  pub fn with_series_type(mut self, series_type: String) -> AltitudeStream {
    self.series_type = Some(series_type);
    self
  }
  ...
  pub fn with_data(mut self, data: Vec<f32>) -> AltitudeStream {
    self.data = Some(data);
    self
  }
