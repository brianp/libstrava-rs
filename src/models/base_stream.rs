...
impl BaseStream {
  ...
  pub fn with_original_size(mut self, original_size: i32) -> BaseStream {
    self.original_size = Some(original_size);
    self
  }
  ...
  pub fn with_resolution(mut self, resolution: String) -> BaseStream {
    self.resolution = Some(resolution);
    self
  }
  ...
  pub fn with_series_type(mut self, series_type: String) -> BaseStream {
    self.series_type = Some(series_type);
    self
  }
